 ...
 */
package org.peanut.seda.monitor;

/**
 * 类MonitorKeys.java的实现描述：监控所对应的key.
 * 
 * @author gm.l 2012-2-11 上午02:24:43
 */
public interface MonitorKeys {

    String QUEUE_FULL_SUFFIX = "_TP_QUEUE_FULL";
    String TASK_COUNT_SUFFIX = "_TASK_COUNT";
}
